# Compares ALL function boundaries discovered by IDA for specific binary, compiled both with symbols (unstripped) and without.
# This script compares all chunks for every function, scattered around the file
import sys

def main(unstripped_func_bounds_file_path, stripped_func_bounds_file_path):
	"""
	Gets stripped+unstripped file paths generated by ida_func_bounds.py,
a	compares function boundaries discovered by IDA in stripped+unstripped binaries and print summarized results
	"""
...
if __name__ == "__main__":
	if len(sys.argv) != 3:
		print "USAGE: %s <unstripped .bounds.auto.py file path> <stripped .bounds.auto.py file path>"
	else:
